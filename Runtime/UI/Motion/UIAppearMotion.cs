...
namespace JoonyleGameDevKit
{
    public class UIAppearMotion : UIMotion
    {
        ...
        public void Prepare()
        {
            if (_enterUsePosition) RectTransform.anchoredPosition = Vector2.zero;
            if (_enterUseScale) RectTransform.localScale = Vector3.zero;
            if (_enterUseRotation) RectTransform.localEulerAngles = _enterTargetRotation1;
        }
