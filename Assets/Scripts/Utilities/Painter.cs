...
namespace JoonyleGameDevKit
{
    public static class Painter
    {
        ...
        private static readonly Vector2 EAST_VEC = new(DEFAULT_LINE_LENGTH, 0f);                        // 悼率
        private static readonly Vector2 WEST_VEC = new(-DEFAULT_LINE_LENGTH, 0f);                       // 辑率
        private static readonly Vector2 SOUTH_VEC = new(0f, -DEFAULT_LINE_LENGTH);                      // 巢率
        private static readonly Vector2 NORTH_VEC = new(0f, DEFAULT_LINE_LENGTH);                       // 合率

        private static readonly Vector2 SE_VEC = new(DEFAULT_LINE_LENGTH, -DEFAULT_LINE_LENGTH);        // 巢悼率
        private static readonly Vector2 SW_VEC = new(-DEFAULT_LINE_LENGTH, -DEFAULT_LINE_LENGTH);       // 巢辑率
        private static readonly Vector2 NW_VEC = new(-DEFAULT_LINE_LENGTH, DEFAULT_LINE_LENGTH);        // 合辑率
        private static readonly Vector2 NE_VEC = new(DEFAULT_LINE_LENGTH, DEFAULT_LINE_LENGTH);         // 合悼率
